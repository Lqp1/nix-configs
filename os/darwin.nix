...
in
{
  ...
  services.skhd.skhdConfig = ''
    ...
    cmd - d : \ls ~/Applications/Home\ Manager\ Apps /Applications/Nix\ Apps /Applications/ /Applications/Utilities/ /System/Applications/ /System/Applications/Utilities/|grep '\.app'|choose|xargs --null open -a
